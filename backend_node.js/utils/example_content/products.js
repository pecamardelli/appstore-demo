...
const products = [
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Fantasy").id,
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Historical Fiction").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Comedy").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Pop").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Jazz").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Classical").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Hip Hop").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Country").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Heavy Metal").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Reggae").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Business Literature").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Action").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Horror").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        displayName:    "Coco",
        CategoryId:     categories.find(s => s.displayName === "Animation").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        displayName:    "Duel",
        CategoryId:     categories.find(s => s.displayName === "Thriller").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        displayName:    "Dunkirk",
        CategoryId:     categories.find(s => s.displayName === "Drama").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Rock").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Science Fiction").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Detective").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Crime").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Adventure").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Young Adult").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
    ...
    },
    {
        ...
        CategoryId:     categories.find(s => s.displayName === "Poetry").id,
        UserId:       getRandomUser(),
        description:    getRandomDescription(),
        price:          getRandomPrice(),
        downloads:      Math.round(Math.random()*1000),
