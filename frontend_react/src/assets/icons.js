...
const getCategoryIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-folder-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getCartIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-cart3" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .49.598l-1 5a.5.5 0 0 1-.465.401l-9.397.472L4.415 11H13a.5.5 0 0 1 0 1H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l.84 4.479 9.144-.459L13.89 4H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"></path>
            </svg>);
}

const getAddToCartIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-cart-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getAddedToCartIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-cart-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 0 0 2 1 1 0 0 0 0-2zm7 0a1 1 0 1 0 0 2 1 1 0 0 0 0-2z"/>
...
const getBuyedIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-bag-check" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getUserIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-person-circle" fill="" xmlns="http://www.w3.org/2000/svg">
...
const getEditIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-pencil-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getDownloadIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-cloud-arrow-down" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getTrashIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-trash" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6z"/>
                <path fillRule="evenodd" d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1zM4.118 4L4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118zM2.5 3V2h11v1h-11z"/>
            </svg>);
}

const getEyeIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-eye" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getReceiptIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-receipt" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getSearchIcon = (size = iconSize) => {
...
const getMailIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-envelope" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getAtIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-at" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getRoleIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-person-badge" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getKeyIcon = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 14 16" className="bi bi-key" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getCaretSquareLeft = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-caret-left-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
const getCaretSquareRight = (size = iconSize) => {
    return (<svg width={ size } height={ size } viewBox="0 0 16 16" className="bi bi-caret-right-square" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fillRule="evenodd" d="M14 1H2a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1zM2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z"/>
...
export default {
    ...
    buyedIcon:          getBuyedIcon,
    userIcon:           getUserIcon,
    editIcon:           getEditIcon,
    downloadIcon:       getDownloadIcon,
    profileIcon:        getProfileIcon,
    trashIcon:          getTrashIcon,
    eyeIcon:            getEyeIcon,
    receiptIcon:        getReceiptIcon,
    searchIcon:         getSearchIcon,
    mailIcon:           getMailIcon,
    atIcon:             getAtIcon, 
    roleIcon:           getRoleIcon,
    keyIcon:            getKeyIcon,
    caretLeft:          getCaretSquareLeft,
    caretRight:          getCaretSquareRight,
